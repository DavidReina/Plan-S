...
7. Create the test cases in sass-spec with the name spec/LibSass-plan-issues/issue_XXX/input.scss and expected_output.css where the XXX is the issue number here.
...
13. The spec is moved from the LibSass-plan-issues folder into LibSass-closed-issues
