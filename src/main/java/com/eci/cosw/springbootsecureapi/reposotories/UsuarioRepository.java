...
public interface UsuarioRepository extends JpaRepository<UsuarioEntity,Integer>{
    ...
    @Modifying
    @Query(value ="insert into usuario (id_usuario, apellidos, contrasena, email, nombres, numero_id, tipo_id, usuario, foto_perfil) values (:id_usuario, :apellidos, :contrasena, :email, :nombres, :numero_id, :tipo_id, :usuario, :fotoperfil)", nativeQuery = true )
    @Transactional
    void registrarUsuario(@Param("id_usuario") int id_usuario, @Param("apellidos") String apellidos, @Param("contrasena") String contrasena, @Param("email") String email, @Param("nombres") String nombres
            , @Param("numero_id") String numero_id, @Param("tipo_id") String tipo_id, @Param("usuario") String usuario, @Param("fotoperfil") String fotoperfil);

    @Modifying
    @Query(value ="UPDATE usuario SET apellidos=:apellidos, contrasena=:contrasena, email=:email, foto_perfil=:fotoperfil, nombres=:nombres, tipo_id=:tipo_id, numero_id=:numero_id, usuario=:usuario WHERE id_usuario=:id_usuario", nativeQuery = true )
    @Transactional
