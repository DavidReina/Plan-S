...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_NumberString__ = __webpack_require__("../../../../../src/app/models/NumberString.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        if (this.userForm.get('contrasena').value != this.userForm.get('confirmcontrasena').value) {
            ...
            this.usersService.update(this.globalUser.usuarioLogin.idUsuario, this.userForm.get('email').value, this.userForm.get('contrasena').value, this.userForm.get('nombres').value, this.userForm.get('apellidos').value, this.userForm.get('usuario').value, this.userForm.get('tipoid').value, new Blob, this.userForm.get('numero_id').value).subscribe(function (serverResponse) {
                ...
                for (var _i = 0, _a = _this.preferenciasSelect; _i < _a.length; _i++) {
                    var pref = _a[_i];
                    _this.numberString = new __WEBPACK_IMPORTED_MODULE_6__models_NumberString__["a" /* NumberString */]();
                    _this.numberString.setNumberPair(serverResponse.idUsuario, pref);
                    _this.numstr.push(_this.numberString);
                }
                _this.usersService.updateUserPreferences(_this.numstr).subscribe(function (response) {
                    return _this.router.navigate(['../userreview']);
                });
            }, function (error) {
    ...
    UserEditPageComponent.prototype.onSubmit = function () {
        ...
        if (this.userForm.get('contrasena').value != this.userForm.get('confirmcontrasena').value) {
            ...
            this.usersService.create(0, this.userForm.get('email').value, this.userForm.get('contrasena').value, this.userForm.get('nombres').value, this.userForm.get('apellidos').value, this.userForm.get('usuario').value, this.userForm.get('tipoid').value, new Blob, this.userForm.get('numero_id').value).subscribe(function (serverResponse) {
                ...
                _this.usersService.registerPreferences(_this.numstr).subscribe(function (response) { return _this.router.navigate(['/signin']); });
            }, function (error) {
...
var UsersService = (function (_super) {
    ...
    UsersService.prototype.updateUserPreferences = function (numstr) {
        console.log(JSON.stringify(numstr));
        return this.post(this.resourceUrl + '/updateUserPreferences', JSON.stringify(numstr), { credentials: false }).map(function (loginResponse) {
            return loginResponse;
        });
    };
    return UsersService;
