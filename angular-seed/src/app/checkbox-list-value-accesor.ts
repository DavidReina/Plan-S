...
import { Directive, ElementRef, forwardRef, Input, Renderer }
    from "@angular/core";
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from "@angular/forms";

export const CHECKBOX_LIST_VALUE_ACCESSOR : any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => CheckboxListValueAccessor),
    multi: true
};
...
export class CheckboxListValueAccessor implements ControlValueAccessor
{
    @Input()
    public value : any;
